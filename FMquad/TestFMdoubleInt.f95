...
!  This is a test program for module FM_DOUBLE_INT, which contains the interface routines allowing
!  quadruple-precision real variables in the user's program to be used in assignments, arithmetic,
